...
<head>
  ...
  <title>Sistem Informasi Pegawai - Home</title>
	<link rel="icon" href="img/Fevicon1.png" type="image/png">
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="hero-banner__img">
              <img class="img-fluid" src="img/logokaryawan1.png" alt="">
            </div>
          </div>
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              <h1>SIKO</h1>
              <p>SIKO Merupakan Sistem Informasi Kominfo, web ini berfungsi sebagai absensi Pegawai dan sebagai sistem informasi karyawan.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">Herlambang Awan Irawan  </p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">0895-1613-3100</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Herlambang Awan Irawan All rights reserved |</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
				<div class="col-lg-4 col-md-12 text-center text-lg-right footer-social">
					<a href="https://www.facebook.com/Herlambang Awan/" target="_blank"><i class="fab fa-facebook-f"></i></a>
					<a href="https://github.com/herlambang awan" target="_blank"><i class="fab fa-github"></i></a>
					<a href="https://www.linkedin.com/in/herlambangaw/" target="_blank" ><i class="fab fa-linkedin" target="_blank"></i></a>
