        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <center><img src="img/logokaryawan1.png" width="500" class="img img-responsive" height="500"></center><br>
                            <strong class="col-md-12" style="margin-top: 5rem;">Selamat datang admin SIKO</strong>
